...
function focusPlusContext(data) {
    ...
    var navXAxis = d3.axisBottom().scale(navXScale);
    ...
    */
     ...
     */
    //HMM..? The big graph's x-axis DOESN'T change according to the brushing. Should do that!
    context.append("g")
        .attr("class", "brush")
        .call(brush);
    
    //context.call(d3.brush().move, [[], []]);
    //context.call(d3.brush().move, xScale.range);
    contect.xScale.range().brush().move;
